...
public class LoginPageGUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        LoginPageLBL.setForeground(new java.awt.Color(102, 102, 102));
        ...
        getContentPane().add(LoginBTN, new org.netbeans.lib.awtextra.AbsoluteConstraints(87, 275, -1, -1));
        ...
        getContentPane().add(ClearBTN, new org.netbeans.lib.awtextra.AbsoluteConstraints(193, 275, -1, -1));

        ResultLBL.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        getContentPane().add(ResultLBL, new org.netbeans.lib.awtextra.AbsoluteConstraints(149, 319, 1, 23));
        ...
        getContentPane().add(NewUserBTN, new org.netbeans.lib.awtextra.AbsoluteConstraints(297, 275, -1, -1));
